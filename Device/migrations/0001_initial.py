    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.CharField(blank=True, choices=[('LED', 'LED'), ('AC', 'AC'), ('TV', 'TV'), ('CURTAIN', 'CURTAIN'), ('PROJECTOR', 'PROJECTOR'), ('AVR', 'AVR'), ('MP', 'MP'), ('BRP', 'BRP'), ('STB', 'STB'), ('CAMERA', 'CAMERA')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devices_details', models.ManyToManyField(to='Device.BmsDeviceInformation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type_slug', models.CharField(choices=[('LED', 'LED'), ('AC', 'AC'), ('TV', 'TV'), ('CURTAIN', 'CURTAIN'), ('PROJECTOR', 'PROJECTOR'), ('AVR', 'AVR'), ('MP', 'MP'), ('BRP', 'BRP'), ('STB', 'STB'), ('CAMERA', 'CAMERA')], max_length=100)),
                ('status', models.CharField(choices=[('Active', 'Active'), ('In-Active', 'In-Active')], default='Active', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
